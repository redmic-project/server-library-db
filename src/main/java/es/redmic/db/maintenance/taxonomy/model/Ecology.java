...
/**
 * The persistent class for the ecology database table.
 * 
 */
@Entity
@Table(name = "ecology")
@NamedQuery(name = "Ecology.findAll", query = "SELECT e FROM Ecology e")
public class Ecology extends DomainModel {

	// bi-directional many-to-one association to Protection
	@OneToMany(mappedBy = "ecology")
